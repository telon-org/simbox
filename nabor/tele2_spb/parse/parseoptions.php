...
file_put_contents("/var/simbox/sim/settings/$imsi.limit.smsday_extra",190);
file_put_contents("/var/simbox/sim/settings/$imsi.smsout_soft",190);
file_put_contents("/var/simbox/sim/settings/$imsi.smsout_hard",190);


//file_put_contents("/var/simbox/sim/settings/$imsi.limit.smsout_extra_sended",200-$sms);
if($sms!=200)
    file_put_contents("/var/simbox/sim/settings/$imsi.smsout_sended",190-$sms);
