...
#define	USB_STS_TIMEOUT		5000 //1000
#define	USB_STS_RETRIES		10   //5
...
#define PORT_RESET_TRIES	10 //5
#define SET_ADDRESS_TRIES	10 //2
#define GET_DESCRIPTOR_TRIES	10 //2
#define SET_CONFIG_TRIES	(10 * (use_both_schemes + 1)) // (2 * (use_both_schemes + 1))
#define USE_NEW_SCHEME(i)	((i) / 10 == (int)old_scheme_first) // ((i) / 2 == (int)old_scheme_first)

#define HUB_ROOT_RESET_TIME	500 //50	/* times are in msec */
#define HUB_SHORT_RESET_TIME	200 //10
#define HUB_BH_RESET_TIME	500 //50
#define HUB_LONG_RESET_TIME	2000 //200
#define HUB_RESET_TIMEOUT	8000 //800
